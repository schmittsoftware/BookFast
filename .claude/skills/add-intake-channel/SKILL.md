...
1. Re-read CLAUDE.md §3 (non-negotiable architecture rules), specifically points 1 (raw/extracted separation), 2 (multi-tenant), and 6 (config-only onboarding).
